    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('Паспорт', 'Паспорт'), ('Приписное/Военник', 'Приписное/Военник'), ('Аттестат/Диплом', 'Аттестат/Диплом'), ('Справка с психодиспансера', 'Справка с психодиспансера'), ('Справка с наркодиспансера', 'Справка с наркодиспансера'), ('Справка о несудимости', 'Справка о несудимости'), ('Согласие на обработку персональных данных', 'Согласие на обработку персональных данных'), ('ИНН', 'ИНН'), ('СНИЛС', 'СНИЛС'), ('Трудовая книжка (опционально)', 'Трудовая книжка (опционально)')], max_length=100, verbose_name='Тип документа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='Ф  Фамилия')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_successful_interview', models.BooleanField(default=False, verbose_name='Успешное собеседование')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('UPLOADED', 'Загружен'), ('UNDER_REVIEW', 'На проверке'), ('ACCEPTED', 'Принят'), ('REJECTED', 'Отклонен')], max_length=20, verbose_name='Статус')),
                ('comment', models.TextField(blank=True, default='', max_length=500, verbose_name='Комментарий')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата изменения')),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='request_app.document')),
            ],
            options={
